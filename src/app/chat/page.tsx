...
export default function ChatPage() {
    ...
    return (
        <Container size="md" py="xl" h="calc(100vh - 80px)">
            <Paper shadow="sm" p="md" radius="md" h="100%" display="flex" style={{ flexDirection: "column" }}>
                ...
                <ScrollArea style={{ flex: 1 }} viewportRef={scrollRef} mb="md">
                    <Stack gap="md" px="xs">
                        {messages.map((msg) => (
                            ...
                            >
                                {msg.role === "ai" && (
                                    <IconRobot size={28} color="var(--mantine-color-emerald-6)" style={{ marginTop: 4 }} />
                                )}
                                {msg.role === "user" && (
                                    <Text size="xs" c="dimmed" style={{ alignSelf: 'flex-end', marginBottom: 4 }}>
                                ...
                                >
                                    <div className="markdown-body" style={{ fontSize: '14px' }}>
                                        <ReactMarkdown
                                            ...
                                            components={{
                                                a: ({ href, children }) => (
                                                    <a href={href} target="_blank" rel="noopener noreferrer" style={{ color: 'var(--mantine-color-emerald-7)', textDecoration: 'underline' }}>
                                                        {children}
                                                    </a>
                                                ),
                        ...
                        {isLoading && (
                            <Group align="center" gap="xs">
                                ...
                                <Text size="sm" c="dimmed">入力中...</Text>
                            </Group>
                        )}
                    </Stack>
                </ScrollArea>

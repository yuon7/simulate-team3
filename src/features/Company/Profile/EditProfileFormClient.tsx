...
import { TextInput, Textarea, NumberInput, Select, Button, Stack, Title, Box, LoadingOverlay } from "@mantine/core";
...
export function EditProfileFormClient({ organization, initialLogoUrl }: EditProfileFormClientProps) {
      ...
      <form action={handleSubmit}>
        <Stack gap="md">
          ...
          <ImageUpload
            ...
            label="組織ロゴ"
          />
          <input type="file" name="logoFile" style={{ display: "none" }} accept="image/png,image/jpeg,image/jpg" />

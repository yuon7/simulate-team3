...
const regions = [
  {
    ...
    description:
      "アルプスの麓で働く。IT企業の誘致が進み、自然と技術が調和した街。",
    jobs: 45,
    population: "24万人",
  ...
  },
  {
    ...
    description:
      "雄大な阿蘇山の恵みを活かした農業・観光業が盛ん。新しい働き方を実現。",
    jobs: 28,
    population: "2.6万人",
      ...
      {regions.map((region, index) => (
        <Grid.Col key={index} span={{ base: 12, sm: 6, lg: 4 }}>
          <Card
            ...
            padding="lg"
            radius="md"
            className={regionCardStyles.regionCard}
          >
            <Card.Section>
              <div className={regionCardStyles.imageWrapper}>
                ...
                />
                <Badge
                  className={regionCardStyles.ratingBadge}
              ...
              <Grid gutter="sm">
                <Grid.Col span={6}>
                  <Group gap="xs">
                    <IconBriefcase
                      size={16}
                      className={regionCardStyles.iconPrimary}
                    />
                ...
                <Grid.Col span={6}>
                  <Group gap="xs">
                    <IconUsers
                      size={16}
                      className={regionCardStyles.iconSecondary}
                    />

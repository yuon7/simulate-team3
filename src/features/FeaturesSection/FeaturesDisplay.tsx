...
const features = [
  ...
  },
  {
    ...
    title: "AIマッチング",
    description:
      "あなたのスキルや希望条件をもとに、AIが最適な求人と地域をおすすめします。",
    color: "orange",
  },
  {
    icon: IconTrendingUp,
    title: "キャリア支援",
    description:
      "地方でのキャリア形成をサポート。スキルアップ研修や転職相談も充実しています。",
    color: "violet",
  },
  {
    icon: IconHeart,
    title: "定着支援",
    description:
      "移住後の生活サポートも万全。地域コミュニティとの繋がりづくりをお手伝いします。",
    color: "pink",
  },
  {
    icon: IconShield,
    title: "安心保証",
    description:
      "移住に関する不安や疑問に24時間対応。専門スタッフがしっかりサポートします。",
    color: "teal",
  },
];
      ...
      {features.map((feature, index) => (
        <Grid.Col key={index} span={{ base: 12, sm: 6, lg: 4 }}>
          ...
          >
            <Stack gap="md">
              <div
                className={displayStyles.iconWrapper}

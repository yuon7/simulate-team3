              ...
              <Stack gap="md">
                ...
                <Group grow>
                  <Select
                    ...
                    data={["1人", "2人", "3人以上"]}
                    value={familySize}
                    onChange={onChangeFamilySize}
                  />
                  <Select
                    label="部屋の広さ (荷物量)"
                    data={Object.keys(ROOM_TYPES_DATA).map((key) => ({
                      value: key,
                      label: ROOM_TYPES_DATA[key].label,
                    }))}
                    value={roomType}
                ...
                <Group justify="space-between" align="center">
                  ...
                  <Switch
                    ...
                    onChange={(e) =>
                      onChangePeakSeason(e.currentTarget.checked)
                    }
                    color="red"
                  />
                </Group>
                ...
                <Divider />
                <Badge color="teal" variant="light" fullWidth>
                  Step 3: 車の準備
                </Badge>
                <SegmentedControl
                  fullWidth
          ...
          <GridCol span={{ base: 12, md: 7 }}>
            <Stack h="100%" justify="center">
              <Paper p="xl" radius="md" withBorder bg="blue.0">
                <Text ta="center" size="sm" fw={700} c="blue.9">
                  移住に必要な推定貯金額
                </Text>
                <Group justify="center" gap="xs" align="flex-end" mt="xs">
                  ...
                  <Text size="xl" fw={700} c="blue.8" mb="sm">
                    万円
                  </Text>
                </Group>
              ...
              <Stack gap="sm">
                <Paper p="sm" withBorder shadow="xs">
                  <Group justify="space-between">
                    <Group gap="xs">
                      <IconHome size={20} color="teal" />
                      <Text fw={600}>賃貸契約初期費用</Text>
                    </Group>
                    <Text fw={700}>
                      {result.housingTotal.toLocaleString()} 円
                    </Text>
                  </Group>
                  <Text size="xs" c="dimmed" mt={4} pl={30}>
                    敷金・礼金 + 前家賃({result.maeyachinCost.toLocaleString()}
                    円)
                  </Text>
                </Paper>
                <Paper p="sm" withBorder shadow="xs">
                  <Group justify="space-between">
                    <Group gap="xs">
                      <IconTruck size={20} color="orange" />
                      <Text fw={600}>引越し費用</Text>
                    </Group>
                    <Text fw={700}>
                      {result.movingTotal.toLocaleString()} 円
                    </Text>
                  </Group>
                  <Text size="xs" c="dimmed" mt={4} pl={30}>
                    {ROOM_TYPES_DATA[roomType]?.label} /{" "}
                    {isPeakSeason ? "繁忙期料金" : "通常期"}
                  </Text>
                </Paper>
                <Paper p="sm" withBorder shadow="xs">
                  <Group justify="space-between">
                ...
                {result.setupTotal > 0 && (
                  <Paper p="sm" withBorder shadow="xs">
                    <Group justify="space-between">
                      <Group gap="xs">
                        <IconSnowflake size={20} color="cyan" />
                        <Text fw={600}>雪国セットアップ</Text>
                      </Group>
                      <Text fw={700}>
                        {result.setupTotal.toLocaleString()} 円
                      </Text>
                    </Group>
                    <Text size="xs" c="dimmed" mt={4} pl={30}>

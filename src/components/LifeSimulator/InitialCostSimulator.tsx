...
import { REGIONS, PREFECTURE_AREAS } from "@/lib/Simulator/supportData"; 
import { getDistFactor, calculateInitialCost, ROOM_TYPES_DATA } from "@/lib/Simulator/InitialLogic";
